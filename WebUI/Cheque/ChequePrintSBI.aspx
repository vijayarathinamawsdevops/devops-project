<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChequePrintSBI.aspx.cs" Inherits="eKaruvoolam.WebUI.Cheque.ChequePrintSBI" %>
...
<head runat="server">
    <title>Cheque Printing For SBI</title>
				...
				<tr>
					<td vAlign="top" height="100%">
						<table class="parabr" cellSpacing="0" cellPadding="2" width="70%" align="center" border="0">
							<tr>
								<td class="formtitle" align="center" colSpan="3"><asp:label id="frmtitle" runat="server" CssClass="formtitle">Generate Cheque For SBI Printing</asp:label></td>
							</tr>
							<TR>
