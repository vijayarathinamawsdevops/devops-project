...
<%@ Page language="c#" Codebehind="ChangePassword.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Cheque.ChangePassword" %>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0">
		<form id="frmChangePassword" method="post" runat="server">
			<table class="tableleftbgcolor" id="Table2" cellSpacing="0" cellPadding="0" width="100%"
				...
				<tr>
					<td valign="top"><uc1:ChequeMenus id="ChequeMenus1" runat="server"></uc1:ChequeMenus></td>
				</tr>
				<tr>
