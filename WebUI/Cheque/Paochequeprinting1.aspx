...
<%@ Page language="c#" Codebehind="Paochequeprinting1.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Reports.Paochequeprinting1" %>
<%@ Register TagPrefix="uc1" TagName="ChequeMenus" Src="../UserControls/ChequeMenus.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>eKaruvoolam - Cheque Printing 1</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="chequeprinting1" method="post" runat="server">
