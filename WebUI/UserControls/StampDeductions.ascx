<%@ Control Language="c#" AutoEventWireup="True" Codebehind="StampDeductions.ascx.cs" Inherits="eKaruvoolam.WebUI.UserControls.StampDeductions" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script language="JavaScript" src="../Scripts/Sqlinjection.js"  type="text/javascript"></script>
<TABLE class="tableleftbgcolor" id="Table1" cellSpacing="1" cellPadding="2" width="100%"
	border="0">
	<tr>
		<td bgColor="#6699cc" colspan="4" align="center"><font color="white" style="FONT-SIZE:9pt"><b>Stamps 
					Discount</b></font></td>
	</tr>
	<TR>
	...
	<TR>
		<TD colSpan="4">
			<asp:DropDownList ID="ddlDPCode" runat="server" Width="150px">
            </asp:DropDownList>
            <%--<asp:textbox id="txtDPCode" MaxLength="15" CssClass="formlines" runat="server" Width="110px">0</asp:textbox>--%>
			<%--<asp:requiredfieldvalidator id="rfvCode" runat="server" ControlToValidate="ddlDPCode" ErrorMessage="*"></asp:requiredfieldvalidator>--%>
			<asp:textbox id="txtAmount" MaxLength="7" CssClass="formlines" runat="server" Width="90px" onblur="chkbadchar(this);">0</asp:textbox>
