<%@ Page language="c#" Codebehind="UnEncahsedChq.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Admin.UnEncahsedChq" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="frmUnEncahed" method="post" runat="server">
				...
				<tr>
					<td vAlign="top" align="center" height="100%">
						<table class="parabr" cellSpacing="5" cellPadding="2" width="80%" align="center" border="0">
							<tr>
								<td class="rptHead" colSpan="5">Report Parameters</td>
							</tr>
							<TR>
								...
								<td><asp:textbox id="txtFromDate" CssClass="formlines" Runat="server" MaxLength="10" onblur="chkbadchar(this);"></asp:textbox>&nbsp;<A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
										href="javascript:show_calendar('frmUnEncahed.txtFromDate')"><IMG src="../Images/show-calendar.gif" align="absMiddle" border="0"></A>
							...
							<tr>
								<td align="center" colSpan="5"><asp:button id="btnSubmit" CssClass="formbuttons" Runat="server" Width="95px" Text="Genarate Report" onclick="btnSubmit_Click"></asp:button></td>
							</tr>
							<tr>
								<td colSpan="5">
