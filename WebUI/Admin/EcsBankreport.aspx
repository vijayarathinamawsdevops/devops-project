...
<%@ Page language="c#" Codebehind="EcsBankreport.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Admin.EcsBankreport" %>
...
<script language="JavaScript" src="../Scripts/Sqlinjection.js"  type="text/javascript"></script>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="frmECSBankAbstract" method="post" runat="server">
			<TABLE class="tableleftbgcolor" id="T1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
				...
				<tr>
					<td vAlign="top" align="center" height="100%">
						<table class="parabr" cellSpacing="5" cellPadding="2" width="85%" align="center" border="0">
							<tr>
								<td class="rptHead" colSpan="5">Bank/Branchwise ECS Abstract Report</td>
							</tr>
							<TR>
								<td align="right"><asp:label id="lbldate" CssClass="mandatory" Runat="server"> Enter Settlement Date(DD/MM/YYYY) format</asp:label></td>
								<td><asp:textbox id="txtFromDate" CssClass="formlines" Runat="server" MaxLength="10" onblur="chkbadchar(this);"></asp:textbox>&nbsp;<A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
                                  ...
                                  CssClass="validatemessage"  ValidationExpression="^(((0[1-9]|[12][0-9]|3[01])([-./])(0[13578]|10|12)([-./])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-./])(0[469]|11)([-./])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-./])(02)([-./])(\d{4}))|((29)(\.|-|\/)(02)([-./])([02468][048]00))|((29)([-./])(02)([-./])([13579][26]00))|((29)([-./])(02)([-./])([0-9][0-9][0][48]))|((29)([-./])(02)([-./])([0-9][0-9][2468][048]))|((29)([-./])(02)([-./])([0-9][0-9][13579][26])))$"></asp:RegularExpressionValidator>
									<asp:label id="Label1" runat="server" CssClass="mandatory">Enter Batch</asp:label><asp:textbox id="txtbatch" CssClass="formlines" Runat="server" MaxLength="7" onblur="chkbadchar(this);"></asp:textbox></td>
							</TR>
							<tr>
								<td align="center" colSpan="5"><asp:button id="btnSubmit" CssClass="formbuttons" Runat="server" Width="95px" Text="Generate Report" onclick="btnSubmit_Click"></asp:button></td>
							</tr>
							<tr>
								<td colSpan="5">
									<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td colSpan="2" style="HEIGHT: 35px"><br>
											</td>
										</tr>
										<tr>
											<td colspan="2" valign="top"><uc1:ReportPage id="ReportPage1" runat="server"></uc1:ReportPage></td>
										</tr>
									</table>
								</td>
							</tr>
