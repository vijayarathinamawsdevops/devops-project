<%@ Page language="c#" Codebehind="LoanDetails.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.PreAuditReports.LoanDetails" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="LoanDetails" method="post" runat="server">
