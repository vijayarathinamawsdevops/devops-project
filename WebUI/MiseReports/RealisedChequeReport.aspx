<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealisedChequeReport.aspx.cs" Inherits="eKaruvoolam.WebUI.MiseReports.RealisedChequeReport" %>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" CssClass="mandatory" 
                        Text="Enter From Cheque Realised Date:&nbsp;"></asp:Label>
                </td>
                <td>
            ...
            face="Courier New" color=#6600ff><STRONG></STRONG></FONT>
                ...
                <td>
                    ...
                    <asp:Label ID="Label2" runat="server" CssClass="mandatory" 
                        Text="Enter To Cheque Realised Date: "></asp:Label>
                </td>
                <td>
