<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PensionRpt.aspx.cs" Inherits="eKaruvoolam.WebUI.MiseReports.PensionRpt" %>
...
<body>
        ...
        <tr>
            ...
            <td align="left" width="15%">
                <asp:DropDownList ID="DrpHead" runat="server" CssClass="drptxt" 
                    ...
                    <asp:ListItem Value="8793">8793</asp:ListItem>
                </asp:DropDownList>
                </td>
            <td align="left" width="10%">
    ...
    <iframe id="iframe1" src=""  target="_blank" runat="server"></iframe>
