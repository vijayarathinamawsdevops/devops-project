<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TNTC70A.aspx.cs" Inherits="eKaruvoolam.WebUI.MiseReports.TNTC70A" %>
        ...
        <table style="width:100%;">
			...
			href="javascript:show_calendar('txtTODate')"><IMG src="../Images/show-calendar.gif" align="absMiddle" border="0"></A>
             <asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server"  CssClass="validatemessage" Display="Dynamic" ControlToValidate="txtTODate"
										ErrorMessage="*"></asp:requiredfieldvalidator>
                                 <asp:RegularExpressionValidator ID="revTranDate0" 
                    runat="server" ControlToValidate="txtTODate" CssClass="validatemessage" 
                    ErrorMessage="Invalid Date" 
                    ValidationExpression="^(((0[1-9]|[12][0-9]|3[01])([-./])(0[13578]|10|12)([-./])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-./])(0[469]|11)([-./])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-./])(02)([-./])(\d{4}))|((29)(\.|-|\/)(02)([-./])([02468][048]00))|((29)([-./])(02)([-./])([13579][26]00))|((29)([-./])(02)([-./])([0-9][0-9][0][48]))|((29)([-./])(02)([-./])([0-9][0-9][2468][048]))|((29)([-./])(02)([-./])([0-9][0-9][13579][26])))$"></asp:RegularExpressionValidator>
                </td>
             ...
             <tr>
                <td>
                <asp:Label ID="lblBAS" runat="server" CssClass="mandatory">BAS</asp:Label></td>
                <td><asp:DropDownList ID="DDLBAS" runat="server" CssClass="formlines"></asp:DropDownList> 
                <asp:RequiredFieldValidator ID="RfvBAS" runat="server" CssClass="validatemessage" ControlToValidate="DDLBAS" Text="Data Required"></asp:RequiredFieldValidator>
                </td>
                <td><asp:Label ID="lblUnit" runat="server" CssClass="mandatory">UNIT</asp:Label></td>
                <td><asp:DropDownList ID="DDLUnit" runat="server" CssClass="formlines"></asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvunit" runat="server" CssClass="validatemessage" ControlToValidate="DDLUnit" Text="Data Required"></asp:RequiredFieldValidator>
                </td>
                <td><asp:Button ID="btnView" runat="server" Text="View Report" CssClass="formbuttons" onclick="btnView_Click" /></td>
                </td></tr></table>
            <tr><td>
                <iframe id="frame1" runat="server" src="" target="_blank" height="470" width="100%" scrolling="yes"></iframe>
                </td></tr>
                <tr>
