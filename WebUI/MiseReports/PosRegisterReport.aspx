<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PosRegisterReport.aspx.cs" Inherits="eKaruvoolam.WebUI.MiseReports.PosRegisterReport" %>
...
<body>
   ...
   <%--<asp:textbox id="txtFromDate" runat="server" CssClass="formlines" MaxLength="10" onblur="chkbadchar(this);"></asp:textbox><A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
    ...
    <%--<asp:HiddenField ID="hifSelect" runat="server" />--%>    <%--<asp:Button ID="btnEdit" runat="server" Text="Button" CssClass="invisiblebtn" 
    ...
    <br />
                <asp:Button ID="btnPrint" runat="server" CssClass="formbuttons" 
                    Text="Take PrintOut" Width="100px" Height="19px" 
        Visible="False" onclick="btnPrint_Click"></asp:Button>
