<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRCashRecovery.aspx.cs"
    Inherits="eKaruvoolam.WebUI.MiseReports.WebForm1" %>

<%@ Register Src="../UserControls/MiseReportsHeader.ascx" TagName="MiseReportsHeader"
    TagPrefix="uc1" %>
   ...
   <asp:textbox id="txtFromDate" runat="server" CssClass="formlines" MaxLength="10" onblur="chkbadchar(this);"></asp:textbox><A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
            ...
            <td align="center" style="width: 0%" width="20%">
                <asp:Button ID="btnView" runat="server" CssClass="formbuttons" Text="View Report"
                    Width="100px" OnClick="btnView_Click" Height="19px"></asp:Button>
                </td>
            <td align="center" style="width: 10%" width="20%">
                <asp:Button ID="btnPrint" runat="server" CssClass="formbuttons" 
                    Text="Take PrintOut" Width="100px"
                    OnClick="btnPrint_Click" Height="19px"></asp:Button>
                </td>
        </tr>
        </table>
