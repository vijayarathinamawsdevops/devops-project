...
<%@ Page language="c#" Codebehind="AudtBillStatus.aspx.cs" AutoEventWireup="True" SmartNavigation="True" Inherits="eKaruvoolam.WebUI.audit.AudtBillStatus" %>
...
<HTML>
	...
	<body id="Audit_BillStatus" leftMargin="0" topMargin="0" rightMargin="0" onload="enableQueryViews();">
											...
											<table cellSpacing="0" cellPadding="2" align="left" border="0">
												<tr>
													...
													<td><asp:textbox id="txtTransactionDate" runat="server" onblur="chkbadchar(this);" CssClass="formlines"></asp:textbox>&nbsp;<A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
															href="javascript:show_calendar('BillStatus.txtTransactionDate');"><IMG src="../Images/show-calendar.gif" border="0"></A>
