...
<%@ Page language="c#" Codebehind="TansiLoan.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.audit.TansiLoan" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>eKaruvoolam - TansiLoan</title>
				...
				<tr>
					<td align="center" height="100%" valign="top">
						<table border="0" cellpadding="1" cellspacing="2" width="98%">
							<TR>
								<TD colSpan="4" style="HEIGHT: 47px; text-align: left;" >
                            ...
                            <table class="parabr">
								...
								<TR>
									...
									<TD width="15%">
										<asp:Label id="lblAmount" runat="server" CssClass="mandatory">Basic Pay (2 Months)</asp:Label></TD>
									<TD width="35%">
							...
							<TR>
								<TD colspan='4'>
									...
									<asp:Label id="lblMessage1" runat="server" CssClass="validatemessage"></asp:Label>&nbsp;
									<asp:TextBox id="todaydate" runat="server" Width="94px" Visible="False" onblur="chkbadchar(this)"></asp:TextBox></TD>
							</TR>
							<TR>
								<TD colSpan="4">
