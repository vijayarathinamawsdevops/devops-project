...
<%@ Page language="c#" Codebehind="EducationCourseType.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Masters.EducationCourseType" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>eKaruvoolam - Education Course Type</title>
	...
	<body MS_POSITIONING="GridLayout" topmargin="0" leftmargin="0" rightmargin="0">
		<form id="EducationCourseType" method="post" runat="server">
				...
				<tr>
					<td align="center" height="100%" valign="top">
						<TABLE id="Table1" class="tableleftbgcolor" cellSpacing="1" cellPadding="1" width="98%"
							border="0">
							<TR>
								<TD width='15%'><asp:Label id="lblCourseType" runat="server" CssClass="mandatory">CourseType</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtCourseType" runat="server" CssClass="formlines" MaxLength="5" onblur="chkbadchar(this);"></asp:TextBox></TD>
								<TD width='15%'><asp:Label id="lblCourseDesc" runat="server" CssClass="mandatory">CourseDesc</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtCourseDesc" runat="server" CssClass="formlines" MaxLength="50" onblur="chkbadchar(this);"></asp:TextBox></TD>
							</TR>
							<TR>
								<TD width='15%'><asp:Label id="lblAmount" runat="server" CssClass="mandatory">Amount</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtAmount" runat="server" CssClass="formlines" MaxLength="10" onblur="chkbadchar(this);"></asp:TextBox></TD>
								<TD colspan="2">&nbsp;</TD>
							</TR>
							<TR>
