...
<%@ Page language="c#" Codebehind="TansiLoanType.aspx.cs" AutoEventWireup="True" SmartNavigation="True" Inherits="eKaruvoolam.WebUI.Masters.TansiLoanType" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>eKaruvoolam - TansiLoanType</title>
	...
	<body MS_POSITIONING="GridLayout" topmargin="0" leftmargin="0" rightmargin="0">
		<form id="TansiLoanType" method="post" runat="server">
				...
				<tr>
					<td align="center" height="100%" valign="top">
						<TABLE id="Table1" class="tableleftbgcolor" cellSpacing="1" cellPadding="1" width="98%"
							border="0">
							<TR>
								<TD width='15%'><asp:Label id="lblLoanType" runat="server" CssClass="mandatory">Loan Type</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtLoanType" runat="server" CssClass="formlines" MaxLength="5" onblur="chkbadchar(this);"></asp:TextBox></TD>
								<TD width='15%'><asp:Label id="lblLoanDesc" runat="server" CssClass="mandatory">Loan Desc</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtLoanDesc" runat="server" CssClass="formlines" MaxLength="30" onblur="chkbadchar(this);"></asp:TextBox></TD>
							</TR>
							<TR>
