...
<%@ Page language="c#" Codebehind="MotorCarType.aspx.cs" AutoEventWireup="True" SmartNavigation="True" Inherits="eKaruvoolam.WebUI.Masters.MotorCarType" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>eKaruvoolam - MotorCarType</title>
	...
	<body MS_POSITIONING="GridLayout" topmargin="0" leftmargin="0" rightmargin="0">
		<form id="MotorCarType" method="post" runat="server">
				...
				<tr>
					<td align="center" height="100%" valign="top">
						<TABLE id="Table1" class="tableleftbgcolor" cellSpacing="1" cellPadding="1" width="98%"
							border="0">
							<TR>
								<TD width='15%'><asp:Label id="lblVechicleType" runat="server" CssClass="mandatory">Vechicle Type</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtVechicleType" runat="server" CssClass="formlines" MaxLength="4" onblur="chkbadchar(this);"></asp:TextBox></TD>
								<TD width='15%'><asp:Label id="lblVechicleDesc" runat="server" CssClass="mandatory">Vechicle Desc</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtVechicleDesc" runat="server" CssClass="formlines" MaxLength="30" onblur="chkbadchar(this);"></asp:TextBox></TD>
							</TR>
							<TR>
								<TD width='15%'><asp:Label id="lblLoanAmount" runat="server" CssClass="mandatory">Loan Amount</asp:Label></TD>
								<TD width='35%'><asp:TextBox id="txtLoanAmount" runat="server" CssClass="formlines" MaxLength="10" onblur="chkbadchar(this);"></asp:TextBox></TD>
								<TD colspan="2">&nbsp;</TD>
							</TR>
							<TR>
