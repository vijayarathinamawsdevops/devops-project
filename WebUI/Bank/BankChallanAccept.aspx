<%@ Page language="c#" Codebehind="BankChallanAccept.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Bank.BankChallanAccept" %>
							...
							<tr>
								<td background="../images/menu_bg.gif">
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="menuon"><A href="BankChallanAccept.aspx">Bank Challan - Entry</A></td>
				...
				<tr>
					<td>
						...
						<table cellSpacing="2" cellPadding="4" width="60%" border="0">
							<tr>
								<TD><asp:label id="lblChallanno" runat="server" CssClass="mandatory">Challan Number</asp:label></TD>
								<TD>
											...
											<TR>
												<TD>
													<asp:button id="btnAccept" tabIndex="7" runat="server" CssClass="formbuttons" Width="110px"
														Text="Accept" onclick="btnAccept_Click"></asp:button></TD>
												<TD>
													<asp:button id="btnIgnore" tabIndex="7" runat="server" CssClass="formbuttons" Width="110px"
														CausesValidation="False" Text="Ignore" onclick="btnIgnore_Click"></asp:button></TD>
												<TD>
