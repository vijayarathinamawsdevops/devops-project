...
<%@ Page language="c#" Codebehind="SPFVolume.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.PreAudit.SPFVolume" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>SPFVolume</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="SPFVolume" method="post" runat="server">
			<table class="tableleftborder" id="Table1" height="100%" cellSpacing="0" cellPadding="0"
								...
								<tr>
									<td align="center">
										<table class="pgborder" cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
											<TBODY>
												<tr class="formtitle">
													<td align="center" colSpan="8">SPFVolume</td>
												</tr>
												<tr>
													<td style="HEIGHT: 57px"><asp:label id="lblGPFNo" Runat="server" CssClass="mandatory">GPFNo</asp:label></td>
													<td style="HEIGHT: 57px"><asp:textbox id="txtGPFNo" Runat="server" CssClass="formlines" onblur="chkbadchar(this);"></asp:textbox><asp:requiredfieldvalidator id="rfvTokenNo" runat="server" CssClass="validatemessage" Visible="False" ControlToValidate="txtEmpIdNo"
													...
													<td style="HEIGHT: 57px"><asp:textbox id="txtGODate" Runat="server" CssClass="formlines" onblur="chkbadchar(this);"></asp:textbox>
                                                     <A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;" 
                                                       href="javascript:show_calendar('txtGODate')"><IMG src="../Images/show-calendar.gif" border="0" align="absMiddle"></A>
                                                    <asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ErrorMessage="Date is dd/MM/yyyy format"  ControlToValidate="txtGODate"
													...
													<td style="HEIGHT: 57px"><asp:label id="lblMcNo" Runat="server" CssClass="mandatory"> G.O.No</asp:label></td>
												...
												<tr>
													<td align="center" colSpan="8"><asp:datagrid id="dgrdspfvolume" Runat="server" Width="100%" GridLines="Horizontal" CellPadding="3"
															...
															<Columns>
																<asp:TemplateColumn HeaderText="SPFID">
																	<ItemTemplate>
																		<asp:Label ID="lbldspfid" Runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"spfid")%>'>
																		</asp:Label>
																	</ItemTemplate>
																</asp:TemplateColumn>
																...
																<asp:TemplateColumn HeaderText="TypeWD">
																	<ItemTemplate>
																		<asp:Label ID="lbldTypeWD" Runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"TypeWD")%>'>
																		</asp:Label>
																	</ItemTemplate>
																</asp:TemplateColumn>
															</Columns>
				...
				<tr>
					<td style="HEIGHT: 33px"><uc1:footer id="Footer1" runat="server"></uc1:footer></td>
				</tr>
			</table>
		</form>
	</body>
