<%@ Page language="c#" Codebehind="BList27C.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.SAReports.frmBlt27CX" %>
<%@ Register TagPrefix="uc1" TagName="ReportPage" Src="../UserControls/ReportPage.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
  <HEAD>
		<title>BList27C</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmBlt27CX" method="post" runat="server">
