...
<%@ Page language="c#" Codebehind="PayFund.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Reports.PayFund" %>
...
<HTML>
  <HEAD>
		<title>eKaruvoolam - Pay Fund</title>
				...
				<tr>
					...
					<td align="left" valign="top" height="100%" style="PADDING-LEFT:20px;PADDING-TOP:20px">
						<table border="0" cellpadding="2" cellspacing="2" width="90%" class="brdr">
							<TR class="formtitle">
								<TD align="center" colSpan="3"><asp:label id="lblFormTitle" CssClass="formtitle" runat="server">Pay Funds - Report</asp:label></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 157px"><asp:Label id="lblBillDate" runat="server" CssClass="mandatory">Date (dd/mm/yyyy): </asp:Label></TD>
								<TD><asp:TextBox id="txtDatTr" runat="server" CssClass="formlines" Enabled="False"></asp:TextBox></TD>
							</TR>
							<TR>
								<TD colspan="2"><asp:Button id="btnGo" runat="server" Text="Generate Report" Width="120px" CssClass="formbuttons" onclick="btnGo_Click"></asp:Button>
