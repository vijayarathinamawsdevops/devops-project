<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NPSReport.aspx.cs" Inherits="eKaruvoolam.WebUI.Reports.NPSReport" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" height="100%">
            ...
            <tr>
                <td colspan="5">&nbsp;&nbsp;<asp:Label ID="lblerror" runat="server" CssClass="validatemessage"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
