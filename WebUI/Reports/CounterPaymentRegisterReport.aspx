<%@ Page language="c#" Codebehind="CounterPaymentRegisterReport.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Reports.CounterPaymentRegisterReport" %>
<%@ Register TagPrefix="uc1" TagName="TopHeader" Src="../UserControls/TopHeader.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ReportPage" Src="../UserControls/ReportPage.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>Counter Payment Register Report</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmCounterPayRegister" method="post" runat="server">
