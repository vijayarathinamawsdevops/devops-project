...
<%@ Page language="c#" Codebehind="MAReportHome.aspx.cs" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Reports.MAReportHome" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>Main Account Report</title>
	...
	<body topmargin="0" leftmargin="0" rightmargin="0">
		<form id="frmSAReportHome" method="post" runat="server">
            ...
            color=#9900ff size=3><U>Back</U></FONT></STRONG></A></td>
							...
							<tr>
								<td colspan="5" class="rptHead"><img src="../Images/report.gif" align="absMiddle">Main 
							...
							<tr>
								...
								<td><asp:TextBox ID="txtFromDate" Runat="server" CssClass="formlines" onblur="chkbadchar(this);"></asp:TextBox>&nbsp;<A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
										href="javascript:show_calendar('txtFromDate')"><IMG src="../Images/show-calendar.gif" border="0" align="absMiddle"></A><asp:requiredfieldvalidator id="rfvTranDate" runat="server" CssClass="validatemessage" ControlToValidate="txtFromDate"
