<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPS-EcsData.aspx.cs" Inherits="eKaruvoolam.WebUI.Reports.CPS_EcsData" %>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0" height="100%">
                ...
                <%--<tr><td align="right" colspan="2"><asp:Button ID="btnCps" runat="server" 
                        Text="Click" onclick="btnCps_Click" /></td></tr>--%>
