...
<%@ Page language="c#" Codebehind="CRChallanInput.aspx.cs" SmartNavigation="True" AutoEventWireup="True" Inherits="eKaruvoolam.WebUI.Input.CRChallanInput" %>
...
<HTML>
	<HEAD>
		<title>eKaruvoolam - CRChallanInput</title>
						...
						<table border="0" cellpadding="2" cellspacing="1" width="98%" 
							...
							<TR>
								...
								<TD width="431" style="WIDTH: 431px"><asp:dropdownlist id="CboChallanYear" runat="server" CssClass="formlines" Width="60"></asp:dropdownlist>
									...
									<asp:textbox id="txtChallanNo" Width="145px" runat="server" CssClass="formlines" ontextchanged="txtChallanNo_TextChanged" onblur="chkbadchar(this);"></asp:textbox>&nbsp;&nbsp;<asp:imagebutton id="ibtnTokenGo" runat="server" ImageAlign="AbsBottom" ImageUrl="../Images/go.gif"
										CausesValidation="False" onclick="ibtnTokenGo_Click"></asp:imagebutton></TD>
								<TD style="HEIGHT: 13px"><asp:label id="Label1" runat="server" CssClass="mandatory">Payment Type</asp:label></TD>
								<TD style="HEIGHT: 13px"><asp:dropdownlist id="cboPaymentType" runat="server" CssClass="drptxt"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD><asp:label id="Label2" runat="server" CssClass="mandatory">DO Code</asp:label></TD>
								<TD>
									<asp:TextBox id="txtDOCode" runat="server" CssClass="formlines" AutoPostBack="True" ontextchanged="txtDOCode_TextChanged" onblur="chkbadchar(this);"></asp:TextBox>
								...
								<TD><asp:label id="Label3" runat="server" CssClass="mandatory">DO Type</asp:label></TD>
								<TD><asp:dropdownlist id="cboDOType" runat="server" CssClass="drptxt"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD><asp:label id="Label4" runat="server" CssClass="mandatory">DP Code(4 Digit)</asp:label></TD>
								<TD><asp:textbox id="txtDPCode" runat="server" CssClass="formlines" MaxLength="4" 
                                        ontextchanged="txtDPCode_TextChanged" onblur="chkbadchar(this);" 
								...
								<TD><asp:label id="Label5" runat="server" CssClass="mandatory">Name of the Remitter</asp:label></TD>
								<TD><asp:textbox id="txtRName" runat="server" CssClass="formlines" onblur="chkbadchar(this);"></asp:textbox></TD>
							</TR>
							<TR>
								<TD><asp:label id="Label6" runat="server" CssClass="mandatory">Challan Amount</asp:label></TD>
								<TD><asp:textbox id="txtBillAmount" runat="server" CssClass="formlines" onblur="chkbadchar(this);"></asp:textbox></TD>
								<TD style="WIDTH: 94px"><asp:label id="lblDateofTr" runat="server" CssClass="mandatory">Date of Transaction</asp:label></TD>
								<TD style="WIDTH: 431px"><asp:textbox id="txtDateofTr" runat="server" 
                                        CssClass="formlines" onblur="chkbadchar(this);"></asp:textbox><A onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"
										href="javascript:show_calendar('txtDateofTr')"><IMG src="../Images/show-calendar.gif" align="absMiddle" border="0"></A>
							...
							<TR>
								<TD colSpan="4"><asp:label id="lblMessage" runat="server" CssClass="mandatory"></asp:label></TD>
							</TR>
							<TR>
								<TD colSpan="4">
									<asp:button id="btnSave" CausesValidation="False" runat="server" CssClass="formbuttons" Text="Save"
